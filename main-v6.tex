...
Conclusions may not transfer to:
\begin{itemize}
...
along all eleven axes of Table~\ref{tab:light}. Whether the
...
applied to \IT{} itself. The artifacts are public at
\url{https://github.com/timm/ezr} and
\url{https://github.com/timm/bitstex}; refutations are welcome.
