...
\usepackage{etoolbox}
\usepackage{geometry}
\usepackage{fvextra} % better control over verbatim environments
% \usepackage{minted}
% \newcommand{\minimintedsize}{\fontsize{6.5}{7}\selectfont}
% \setminted{
%     fontsize=\minimintedsize,   % small but still legible
%     breaklines=true,         % allow line breaks
%     breakanywhere=true,      % allow breaks within identifiers if needed
%     linenos=false,           % set to true if you want line numbers
%     tabsize=2,               % standard Python tab size
%     %frame=lines,             % or "single" for a box
%     baselinestretch=1.0,     % tighter vertical spacing
%     escapeinside=||,         % if you want math escapes
%     style=tango              % or "borland", "bw", etc. as desired
% }
% \AtBeginEnvironment{minted}{\vspace{-0.5em}}
% \AtEndEnvironment{minted}{\vspace{-0.5em}}

% \usepackage{float} % must come first
% \usepackage{caption}
% \newfloat{listing}{htbp}{lop}
% \floatname{listing}{Listing}
% \restylefloat{listing} % a

% \newcommand{\CODE}[1]{%
%   \begin{listing}
%   \inputminted{python}{tex/#1}
%   \caption{\texttt{#1}}
%   \label{lst:#1}
%   \end{listing}
% }
...
\newcommand{\CODE}[1]{%
  \begin{listing}
  \lstinputlisting[style=pythonstyle]{tex/#1}
  \caption{\texttt{#1}}
  \label{lst:#1}
  \end{listing}
}
